...
use Modules\AccessControl\App\Http\Requests\StoreUserRequest;
use Modules\AccessControl\App\Http\Requests\UpdateUserRequest;
...
class UserController extends Controller
{
    ...
    {
        return Inertia::render('access-control::User/index', $this->listProps($request));
    }
    ...
    {
        return Inertia::render('access-control::User/index', [
